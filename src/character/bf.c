...
static const CharFrame char_bf_frame[] = {
	{BF_ArcMain_Idle, {  0,   0, 125, 128}, { 53,  92}}, //0 idle 1
	{BF_ArcMain_Idle, {128,   0, 125, 128}, { 53,  93}}, //1 idle 2
	{BF_ArcMain_Idle, {  0, 128, 125, 128}, { 53,  98}}, //2 idle 3
	{BF_ArcMain_Idle, {128, 128, 125, 128}, { 53,  98}}, //3 idle 4
	
	{BF_ArcMain_Hit0,  {  0,   0, 125, 128}, { 56,  94}}, //4 left 1
	{BF_ArcMain_Hit0,  {128,   0, 125, 128}, { 56,  94}}, //5 left 2
	{BF_ArcMain_Miss0, {  0,   0, 125, 128}, { 52, 102}}, //6 left miss 1
	{BF_ArcMain_Miss0, {128,   0, 125, 128}, { 53, 102}}, //7 left miss 2
	
	{BF_ArcMain_Hit0,  {  0, 128, 125, 128}, { 50,  82}}, //8 down 1
	{BF_ArcMain_Hit0,  {128, 128, 125, 128}, { 50,  83}}, //9 down 2
	{BF_ArcMain_Miss0, {  0, 128, 125, 128}, { 49,  90}}, //10 down miss 1
	{BF_ArcMain_Miss0, {128, 128, 125, 128}, { 50,  90}}, //11 down miss 2
	
	{BF_ArcMain_Hit1,  {  0,   0, 125, 128}, { 42, 103}}, //12 up 1
	{BF_ArcMain_Hit1,  {128,   0, 125, 128}, { 44, 102}}, //13 up 2
	{BF_ArcMain_Miss1, {  0,   0, 125, 128}, { 48,  99}}, //14 up miss 1
	{BF_ArcMain_Miss1, {128,   0, 125, 128}, { 48, 100}}, //15 up miss 2
	
	{BF_ArcMain_Hit1,  {  0, 128, 125, 128}, { 42,  94}}, //16 right 1
	{BF_ArcMain_Hit1,  {128, 128, 125, 128}, { 42,  95}}, //17 right 2
	{BF_ArcMain_Miss1, {  0, 128, 125, 128}, { 45, 102}}, //18 right miss 1
	{BF_ArcMain_Miss1, {128, 128, 125, 128}, { 43, 102}}, //19 right miss 2
...
void Char_BF_Tick(Character *character)
{
	...
	if ((stage.stage_id == StageId_1_1) && stage.song_step >= 10)
	{
		this->character.focus_x = FIXED_DEC(-70,1);
		this->character.focus_y = FIXED_DEC(-100,1);
		this->character.focus_zoom = FIXED_DEC(25, 10);
	}

	if ((stage.stage_id == StageId_1_1) && stage.song_step >= 20)
	{
		this->character.focus_x = FIXED_DEC(-58,1);
