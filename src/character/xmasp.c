...
static const CharFrame char_xmasp_frame[] = {
	{XmasP_ArcMain_Idle0, {0,   0, 219, 196}, {130, 192}}, //0 idle 1
	{XmasP_ArcMain_Idle1, {0,   0, 219, 192}, {131, 188}}, //1 idle 2
	{XmasP_ArcMain_Idle2, {0,   0, 221, 193}, {130, 189}}, //2 idle 3
	{XmasP_ArcMain_Idle3, {0,   0, 217, 196}, {127, 192}}, //3 idle 4
	
	{XmasP_ArcMain_LeftA0, {0,   0, 197, 201}, {123, 202}}, //4 left a 1
	{XmasP_ArcMain_LeftA1, {0,   0, 201, 201}, {125, 202}}, //5 left a 2
	{XmasP_ArcMain_LeftA0, {0,   0, 197, 201}, {123, 202}}, //4 left a 1
	{XmasP_ArcMain_LeftA1, {0,   0, 201, 201}, {125, 202}}, //5 left a 2
	
	{XmasP_ArcMain_DownA0, {0,   0, 213, 189}, {120, 190}}, //8 down a 1
	{XmasP_ArcMain_DownA1, {0,   0, 213, 190}, {122, 191}}, //9 down a 2
	{XmasP_ArcMain_DownB0, {0,   0, 213, 189}, {121, 177}}, //10 down b 1
	{XmasP_ArcMain_DownB1, {0,   0, 213, 190}, {123, 178}}, //11 down b 2
	
	{XmasP_ArcMain_UpA0, {0,   0, 199, 203}, {117, 204}}, //12 up a 1
	{XmasP_ArcMain_UpA1, {0,   0, 201, 203}, {120, 204}}, //13 up a 2
	{XmasP_ArcMain_UpB0, {0,   0, 197, 204}, {117, 205}}, //14 up b 1
	{XmasP_ArcMain_UpB1, {0,   0, 201, 202}, {119, 203}}, //15 up b 2
	
	{XmasP_ArcMain_RightA0, {0,   0, 239, 187}, {128, 188}}, //16 right a 1
	{XmasP_ArcMain_RightA1, {0,   0, 239, 191}, {130, 192}}, //17 right a 2
