...
static struct
{
	...
	Character *gft; //Title Girlfriend
} menu;
...
void Menu_Load(MenuPage page)
{
	...
	menu.gft = Char_gft_New(FIXED_DEC(70,1), FIXED_DEC(20,1));
	...
	//Fallthrough
		...
		case MenuPage_Story:
		{
			static const struct
			{
				...
				{"1", StageId_1_1, "YOU MET A TERRILE FATE", {"DROWNING"}},
				{NULL, StageId_1_2, "REAL BEN", {"EXPURGATION"}},
			};
		...
		case MenuPage_Freeplay:
		{
			static const struct
			{
				...
				{StageId_1_1, "DROWNING"},
				{StageId_1_2, "EXPURGATION"},
			};
		...
		case MenuPage_Mods:
		{
			static const struct
			{
				...
				{StageId_Clwn_2, "	OG DROWNIN MOD", false},
				{StageId_Clwn_2, "INSIDESOULS", false},
				{StageId_Clwn_2, "SARUKY", false},
				{StageId_Clwn_2, "ALAIRA", false},
				{StageId_Kapi_1, "	PSXFUNKIN BY", false},
				{StageId_Kapi_2, "CUCKYDEV", false},	
				{StageId_Kapi_2, "	CODING HELP", false},	
				{StageId_Clwn_1, "IGORSOU3000", false},
				{StageId_Clwn_1, "	SPRITES AND IMAGES", false},
				{StageId_Clwn_1, "MR P", false},
				{StageId_Clwn_1, "UNSTOPABLE", false},
				{StageId_Clwn_1, "	CODING", false},
				{StageId_Clwn_1, "UNSTOPABLE", false},
